...
Sherpas.MasterBook = (function(){
  ...
  function _buildMonth(ss, ym){
    ...
    sh.getRange(3,1,lastDay,1).setValues(values);            // setValues por bloque (rendimiento)  :contentReference[oaicite:1]{index=1}
  ...
  function _applyDVandCF_ForCols(sheet, colM, colT){
    ...
    var ruleM = Sherpas.DVManager.buildListRule(Sherpas.CFG.MASTER_DV_M); // DataValidationBuilder  :contentReference[oaicite:2]{index=2}
